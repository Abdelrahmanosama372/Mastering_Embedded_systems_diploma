...
//clock enable Macros:
//-*-*-*-*-*-*-*-*-*-*-*
#define RCC_GPIOA_ENABLE()     (RCC->APB2RSTR |= 1<<2)
#define RCC_GPIOB_ENABLE()     (RCC->APB2RSTR |= 1<<3)
#define RCC_GPIOC_ENABLE()     (RCC->APB2RSTR |= 1<<4)
#define RCC_GPIOD_ENABLE()     (RCC->APB2RSTR |= 1<<5)
#define RCC_GPIOE_ENABLE()     (RCC->APB2RSTR |= 1<<6)

#define RCC_AFIO_ENABLE()      (RCC->APB2RSTR |= 1<<0)
